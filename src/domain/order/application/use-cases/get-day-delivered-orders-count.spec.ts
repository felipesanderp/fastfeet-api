...
import { GetDayDeliveredOrdersCountUseCase } from './get-day-delivered-orders-count'
...
let sut: GetDayDeliveredOrdersCountUseCase

describe('Get Day Delivered Orders', () => {
  beforeEach(() => {
    ...
    sut = new GetDayDeliveredOrdersCountUseCase(inMemoryOrdersRepository)
  })

  it('should be able to get day delivered orders', async () => {
