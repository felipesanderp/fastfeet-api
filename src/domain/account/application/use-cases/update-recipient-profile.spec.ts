...
import { UpdateRecipientProfileUseCase } from './update-recipient-profile'
...
describe('Update Recipient Profile', () => {
  beforeEach(() => {
    ...
    sut = new UpdateRecipientProfileUseCase(inMemoryRecipientsRepository)
  })

  it('should be able to update a recipient profile', async () => {
